...
- API version: 1.6.0-beta7
- Package version: 1.6.0-beta7
...
*FileSetsApi* | [**put_file_chunk**](docs/FileSetsApi.md#put_file_chunk) | **PUT** /file-sets/inbound/{inboundFileSetId}/{fileIndex}/{chunkIndex} | Upload a specific file chunk for an inbound file set.
...
## Documentation For Models
 ...
 - [FileContentError](docs/FileContentError.md)
 - [FileInfo](docs/FileInfo.md)
 - [FileNotice](docs/FileNotice.md)
 ...
 - [InboundFileInfo](docs/InboundFileInfo.md)
 ...
 - [InboundFileSetInvalidStateProblemDetails](docs/InboundFileSetInvalidStateProblemDetails.md)
 ...
 - [OutboundFileSetInvalidStateProblemDetails](docs/OutboundFileSetInvalidStateProblemDetails.md)
