...
class WaarderingInputParameters(ModelNormal):
    ...
    def _from_openapi_data(cls, product_type, bag_nummeraanduiding_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            hypotheekwaarde (int): Verplicht voor de producttypen `modelwaardeDesktopTaxatie` en `desktopTaxatie`.  In hele euros.. [optional]  # noqa: E501
            ...
            klantwaarde_type (bool, date, datetime, dict, float, int, list, str, none_type): Verplicht voor de producttypen `modelwaardeDesktopTaxatie` en `desktopTaxatie`. | Waarde | Omschrijving | | --- | --- | | `onbekend` |  | | `koopsom` |  | | `taxatiewaarde` |  | | `wozWaarde` |  | | `eigenWaardeinschatting` |  |   . [optional]  # noqa: E501
            ...
            is_bestaande_nhg_hypotheek (bool): Optioneel te gebruiken voor de producttypen `modelwaardeDesktopTaxatie` en `desktopTaxatie`.  Geeft aan of er bij de eventuele bestaande hypotheek gebruik is gemaakt van de Nationale Hypotheekgarantie.. [optional]  # noqa: E501
