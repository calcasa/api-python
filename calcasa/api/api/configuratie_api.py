...
class ConfiguratieApi:
    ...
    @validate_call
    def get_callback_authentication(
        self,
        ...
        _param = self._get_callback_authentication_serialize(
    ...
    @validate_call
    def get_callback_authentication_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_callback_authentication_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_callback_authentication_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/configuratie/callbacks/authentication",
    ...
    def get_mtls_certificate(
        ...
        _param = self._get_mtls_certificate_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    def get_mtls_certificate_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_mtls_certificate_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_mtls_certificate_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/configuratie/callbacks/mtls-certificate",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_signature_keys(
        ...
        _param = self._get_signature_keys_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    def get_signature_keys_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_signature_keys_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_signature_keys_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/configuratie/callbacks/signature-keys",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def post_callback_authentication(
        self,
        callback_authentication: CallbackAuthentication,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._post_callback_authentication_serialize(
            callback_authentication=callback_authentication,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    def post_callback_authentication_with_http_info(
        self,
        callback_authentication: CallbackAuthentication,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_callback_authentication_without_preload_content(
        self,
        callback_authentication: CallbackAuthentication,
        _request_timeout: Union[
            None,
    ...
    def _post_callback_authentication_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if callback_authentication is not None:
            _body_params = callback_authentication
