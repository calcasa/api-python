...
class Bodemdata(BaseModel):
    ...
    datum_laatste_onderzoek: Optional[date] = Field(default=None, description="De datum van het laatste bodemonderzoek.", alias="datumLaatsteOnderzoek")
    url: Optional[StrictStr] = Field(default=None, description="De url met informatie over het bodemonderzoek.")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.datum_laatste_onderzoek is None and "datum_laatste_onderzoek" in self.model_fields_set:
