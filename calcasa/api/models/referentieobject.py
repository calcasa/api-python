...
class Referentieobject(BaseModel):
    ...
    Referentieobject
    """ # noqa: E501
    afstand: Optional[StrictInt] = Field(default=None, description="Afstand tot het waarderingsobject in meters.")
    verkoopprijs: Optional[StrictInt] = Field(default=None, description="In hele euros.")
    gecorrigeerde_verkoopprijs: Optional[StrictInt] = Field(default=None, description="In hele euros.", alias="gecorrigeerdeVerkoopprijs")
    geindexeerde_verkoopprijs: Optional[StrictInt] = Field(default=None, description="In hele euros.", alias="geindexeerdeVerkoopprijs")
    vierkantemeterprijs: Optional[StrictInt] = Field(default=None, description="In hele euros per vierkante meters.")
    gecorrigeerde_vierkantemeterprijs: Optional[StrictInt] = Field(default=None, description="In hele euros per vierkante meters.", alias="gecorrigeerdeVierkantemeterprijs")
    geindexeerde_vierkantemeterprijs: Optional[StrictInt] = Field(default=None, description="In hele euros per vierkante meters.", alias="geindexeerdeVierkantemeterprijs")
    ...
    fotos: Optional[List[Foto]] = Field(default=None, description="Fotos van het referentieobject.")
    bijzonderheden: Optional[List[VerkoopBijzonderheden]] = Field(default=None, description="Eventuele bijzonderheden van de transactie.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["afstand", "verkoopprijs", "gecorrigeerdeVerkoopprijs", "geindexeerdeVerkoopprijs", "vierkantemeterprijs", "gecorrigeerdeVierkantemeterprijs", "geindexeerdeVierkantemeterprijs", "verkoopdatum", "adres", "object", "cbsIndeling", "fotos", "bijzonderheden"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gecorrigeerdeVierkantemeterprijs": obj.get("gecorrigeerdeVierkantemeterprijs"),
            "geindexeerdeVierkantemeterprijs": obj.get("geindexeerdeVierkantemeterprijs"),
