...
*FileSetsApi* | [**confirm_inbound_file_set_by_id**](docs/FileSetsApi.md#confirm_inbound_file_set_by_id) | **PUT** /file-sets/inbound/{inboundFileSetId} | 
*FileSetsApi* | [**create_inbound_file_set**](docs/FileSetsApi.md#create_inbound_file_set) | **POST** /file-sets/inbound | 
...
*FileSetsApi* | [**get_outbound_file_by_index**](docs/FileSetsApi.md#get_outbound_file_by_index) | **GET** /file-sets/outbound/{outboundFileSetId}/{fileIndex} | Get a specific outbound file content by its index within a file set.  Used the Http Range header to request a specific byte range of the file.  If the Range header is not provided, the entire file will be returned.
...
## Documentation For Models
 ...
 - [FileSetsFileInfo](docs/FileSetsFileInfo.md)
 - [FileSetsFileSet](docs/FileSetsFileSet.md)
 - [FileSetsInboundFileSet](docs/FileSetsInboundFileSet.md)
 - [FileSetsInboundFileSetWebhookPayload](docs/FileSetsInboundFileSetWebhookPayload.md)
 - [FileSetsOutboundFileSet](docs/FileSetsOutboundFileSet.md)
 - [FileSetsOutboundFileSetWebhookPayload](docs/FileSetsOutboundFileSetWebhookPayload.md)
 ...
 - [InboundFileSetAlreadyCompletedProblemDetails](docs/InboundFileSetAlreadyCompletedProblemDetails.md)
