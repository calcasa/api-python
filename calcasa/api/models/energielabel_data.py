...
class EnergielabelData(BaseModel):
    ...
    EnergielabelData
    """ # noqa: E501
    aantal_sterren: Optional[StrictInt] = Field(default=None, description="Het aantal sterren van het energielabel. 1 is voorlopig label. 3 is beperkt definitief label (zonder energieprestatie-index). 4 is definitief label met energieprestatie-index.", alias="aantalSterren")
    geldig_tot: Optional[date] = Field(default=None, description="De registratiedatum. Beschikbaar voor 2 en 3 sterrenlabels.", alias="geldigTot")
    registratiedatum: Optional[date] = Field(default=None, description="De datum tot wanneer het label geldig is. Beschikbaar voor 2 en 3 sterrenlabels.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["aantalSterren", "geldigTot", "registratiedatum"]
