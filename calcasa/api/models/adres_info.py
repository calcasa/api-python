...
class AdresInfo(BaseModel):
    ...
    AdresInfo
    """ # noqa: E501
    bag_nummeraanduiding_id: StrictInt = Field(description="Het BAG nummeraanduiding Id van het adres. Normaal aangevuld met nullen tot 16 karakters.", alias="bagNummeraanduidingId")
    adres: Optional[Adres] = None
    notities: Optional[Notities] = None
    adres_gevonden: Optional[StrictBool] = Field(default=None, description="Geeft aan of er een correct adres is gevonden voor deze zoekopdracht.", alias="adresGevonden")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["bagNummeraanduidingId", "adres", "notities", "adresGevonden"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "notities": Notities.from_dict(obj["notities"]) if obj.get("notities") is not None else None,
