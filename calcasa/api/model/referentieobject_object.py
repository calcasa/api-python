...
class ReferentieobjectObject(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ReferentieobjectObject - a model defined in OpenAPI
