...
class GeldverstrekkersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_geldverstrekkers_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': 'get_geldverstrekkers',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_geldverstrekkers(
        ...
        **kwargs
        ...
        """Alle geldverstrekkers die te gebruiken zijn voor aanvragen.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_geldverstrekkers(product_type, async_req=True)
        >>> result = thread.get()

        Args:
            product_type (bool, date, datetime, dict, float, int, list, str, none_type): Een parameter om de lijst te filteren op gesupporte producttypen.
        ...
        kwargs['product_type'] = \
            product_type
        return self.get_geldverstrekkers_endpoint.call_with_http_info(**kwargs)
