...
class Bestemmingsdata(BaseModel):
    ...
    Bestemmingsdata
    """ # noqa: E501
    enkelbestemming: Optional[StrictStr] = Field(default=None, description="De enkelbestemming volgens het bestemmingsplan.")
    datum_bestemmingplan: Optional[date] = Field(default=None, description="De datum waarop dit bestemmingsplan vastgelegd is.", alias="datumBestemmingplan")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # and model_fields_set contains the field
        if self.datum_bestemmingplan is None and "datum_bestemmingplan" in self.model_fields_set:
