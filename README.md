...
*FileSetsApi* | [**confirm_inbound_file_set_by_id**](docs/FileSetsApi.md#confirm_inbound_file_set_by_id) | **POST** /file-sets/inbound/{inboundFileSetId} | Confirm an inbound file set after it has been fully uploaded.
