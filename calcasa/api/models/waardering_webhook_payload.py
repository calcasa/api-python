...
class WaarderingWebhookPayload(BaseModel):
    ...
    event_id: StrictStr = Field(description="Uniek Id voor deze callback.", alias="eventId")
    timestamp: datetime = Field(description="Het tijdstip van het event, in UTC.")
    waardering_id: Optional[StrictStr] = Field(default=None, description="Het Id van de waardering waarop deze callback betrekking heeft.", alias="waarderingId")
    ...
    is_test: Optional[StrictBool] = Field(default=None, description="Geeft aan of de betreffende waardering aangevraagd is met een test token.", alias="isTest")
    externe_referentie: Optional[StrictStr] = Field(default=None, description="Dit is de externe referentie opgegeven bij de callback inschrijving of als dit een normale API waardering is waarvoor geen callback inschrijving was dit veld null.", alias="externeReferentie")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["callbackName", "eventId", "timestamp", "waarderingId", "oldStatus", "newStatus", "isTest", "externeReferentie"]
