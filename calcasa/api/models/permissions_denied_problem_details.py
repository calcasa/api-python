...
class PermissionsDeniedProblemDetails(BaseModel):
    ...
    """ # noqa: E501
    required_permission: Optional[StrictStr] = Field(default=None, alias="requiredPermission")
    ...
    __properties: ClassVar[List[str]] = ["requiredPermission", "type", "title", "status", "detail", "instance"]
