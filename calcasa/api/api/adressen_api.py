...
class AdressenApi:
    ...
    def get_adres(
        self,
        bag_nummeraanduiding_id: Annotated[StrictInt, Field(description="Een BAG Nummeraanduiding ID om een adres te specificeren.")],
    ...
    def search_adres(
        self,
        adres: Annotated[Adres, Field(description="Het adres object dat gebruikt wordt om te zoeken naar adres informatie.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
