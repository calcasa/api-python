...
class ProductCheckParameters(BaseModel):
    ...
    benodigde_overbrugging: Optional[StrictInt] = Field(
        default=None,
        description="Verplicht voor de combinatie van de producttypen `modelwaardeDesktopTaxatie`, `desktopTaxatie` en `desktopTaxatiePlus` en het aanvraagdoel `overbruggingsfinanciering`. In hele euros.",
