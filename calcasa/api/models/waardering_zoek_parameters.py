...
class WaarderingZoekParameters(BaseModel):
    ...
    """ # noqa: E501
    aangemaakt: Optional[datetime] = Field(default=None, description="De datum/tijd waarop de waardering is aangemaakt, in UTC.")
    geldverstrekker: Optional[StrictStr] = Field(default=None, description="De naam van de geldverstrekker voor de waardering.")
    product_type: ProductType = Field(alias="productType")
    aanvraagdoel: Optional[Aanvraagdoel] = None
    waardering_status: Optional[WaarderingStatus] = Field(default=None, alias="waarderingStatus")
    bag_nummeraanduiding_id: StrictInt = Field(description="Verplicht.", alias="bagNummeraanduidingId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["aangemaakt", "geldverstrekker", "productType", "aanvraagdoel", "waarderingStatus", "bagNummeraanduidingId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # and model_fields_set contains the field
        if self.waardering_status is None and "waardering_status" in self.model_fields_set:
