...
class CallbacksApi:
    ...
    def add_or_update_callback_subscription(
        self,
        callback_inschrijving: Annotated[CallbackInschrijving, Field(description="De te configureren callback inschrijving.")],
    ...
    def delete_notification_subscription(
        self,
        bag_nummeraanduiding_id: Annotated[StrictInt, Field(description="Het BAG Nummeraanduiding ID waar de callback inschrijving voor geldt.")],
        geldverstrekker: Annotated[Optional[StrictStr], Field(description="De naam van de geldverstrekker waar de callback inschrijving voor geldt.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
