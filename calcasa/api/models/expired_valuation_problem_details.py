...
class ExpiredValuationProblemDetails(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExpiredValuationProblemDetails from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if originele_aanmaak_datum (nullable) is None
        # and model_fields_set contains the field
        if (
            self.originele_aanmaak_datum is None
            and "originele_aanmaak_datum" in self.model_fields_set
        ):
            _dict["origineleAanmaakDatum"] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExpiredValuationProblemDetails from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "origineleAanmaakDatum": obj.get("origineleAanmaakDatum"),
                "type": obj.get("type"),
                "title": obj.get("title"),
