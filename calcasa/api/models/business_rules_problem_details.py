...
class BusinessRulesProblemDetails(BaseModel):
    ...
    """ # noqa: E501
    business_rules_code: Optional[BusinessRulesCode] = Field(default=None, alias="businessRulesCode")
    type: Optional[StrictStr] = Field(default=None, description="A URI reference [RFC3986] that identifies the problem type.")
    ...
    __properties: ClassVar[List[str]] = ["businessRulesCode", "type", "title", "status", "detail", "instance"]
